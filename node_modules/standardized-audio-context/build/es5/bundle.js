(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/typeof'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('@babel/runtime/helpers/inherits'), require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/assertThisInitialized'), require('@babel/runtime/helpers/objectWithoutProperties')) :
    typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/typeof', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/slicedToArray', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf', '@babel/runtime/helpers/inherits', '@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/assertThisInitialized', '@babel/runtime/helpers/objectWithoutProperties'], factory) :
    (global = global || self, factory(global.standardizedAudioContext = {}, global._typeof, global._classCallCheck, global._slicedToArray, global._defineProperty, global._createClass, global._possibleConstructorReturn, global._getPrototypeOf, global._inherits, global._regeneratorRuntime, global._asyncToGenerator, global._toConsumableArray, global._assertThisInitialized, global._objectWithoutProperties));
}(this, function (exports, _typeof, _classCallCheck, _slicedToArray, _defineProperty, _createClass, _possibleConstructorReturn, _getPrototypeOf, _inherits, _regeneratorRuntime, _asyncToGenerator, _toConsumableArray, _assertThisInitialized, _objectWithoutProperties) { 'use strict';
    ...
    var AUDIO_PARAM_AUDIO_NODE_STORE = new WeakMap();
    var AUXILIARY_GAIN_NODE_STORE = new WeakMap();
    var BACKUP_NATIVE_CONTEXT_STORE = new WeakMap();
    var CONTEXT_STORE = new WeakMap();
    var DETACHED_ARRAY_BUFFERS = new WeakSet();
    var EVENT_LISTENERS = new WeakMap(); // This clunky name is borrowed from the spec. :-)
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function AnalyserNode(context) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(AnalyserNode).call(this, context, 'passive', nativeAnalyserNode, analyserNodeRenderer));
    ...
    var getAudioNodeConnections = function getAudioNodeConnections(audioNode) {
      var audioGraph = getAudioGraph(audioNode.context);
      return getValueForKey(audioGraph.nodes, audioNode);
    };

    var getAudioNodeRenderer = function getAudioNodeRenderer(audioNode) {
    ...
    var renderInputsOfAudioNode = function renderInputsOfAudioNode(audioNode, nativeOfflineAudioContext, nativeAudioNode) {
      ...
      return Promise.all(audioNodeConnections.activeInputs.map(function (connections, input) {
        return Array.from(connections).map(function (_ref) {
    ...
    var setInternalState = function setInternalState(audioNode, internalState) {
      ...
      getEventListenersOfAudioNode(audioNode).forEach(function (eventListener) {
        return eventListener(internalState);
      });
    };
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function AudioBufferSourceNode(context) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(AudioBufferSourceNode).call(this, context, 'passive', nativeAudioBufferSourceNode, audioBufferSourceNodeRenderer));
          ...
          _createClass(AudioBufferSourceNode, [{
            ...
            value: function start() {
              ...
              if (this._audioBufferSourceNodeRenderer !== null) {
                ...
                var setInternalStateToInactive = function setInternalStateToInactive() {
                  _this2._nativeAudioBufferSourceNode.removeEventListener('ended', setInternalStateToInactive); // @todo Determine a meaningful delay instead of just using one second.


                  setTimeout(function () {
                    return setInternalState(_this2, 'passive');
                  }, 1000);
                };
    ...
    var renderInputsOfAudioParam = function renderInputsOfAudioParam(context, audioParam, nativeOfflineAudioContext, nativeAudioParam) {
      ...
      return Promise.all(Array.from(audioParamConnections.activeInputs).map(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 2),
            source = _ref2[0],
            output = _ref2[1];
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 8;
                    return renderAutomation(proxy.context, nativeOfflineAudioContext, proxy.playbackRate, nativeAudioBufferSourceNode.playbackRate);
                  ...
                  case 10:
                    _context.next = 12;
                    return connectAudioParam(proxy.context, nativeOfflineAudioContext, proxy.playbackRate);
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function AudioDestinationNode(context, channelCount) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(AudioDestinationNode).call(this, context, 'passive', nativeAudioDestinationNode, audioDestinationNodeRenderer));
    ...
    var connectNativeAudioNodeToNativeAudioNode = function connectNativeAudioNodeToNativeAudioNode(nativeSourceAudioNode, nativeDestinationAudioNode, output, input) {
      var inputs = nativeDestinationAudioNode.inputs;
    ...
    var addConnectionToAudioNodeOfAudioContext = function addConnectionToAudioNodeOfAudioContext(source, destination, output, input) {
      ...
      var eventListener = function eventListener(type) {
      ...
      insertElementInSet(outputs, [destination, output, input], function (outputConnection) {
    ...
    var addConnectionToAudioParamOfAudioContext = function addConnectionToAudioParamOfAudioContext(source, destination, output) {
      var _getAudioParamConnect = getAudioParamConnections(source.context, destination),
      ...
      insertElementInSet(outputs, [destination, output], function (outputConnection) {
    ...
    var addConnectionToAudioParamOfOfflineAudioContext = function addConnectionToAudioParamOfOfflineAudioContext(source, destination, output) {
      var _getAudioParamConnect2 = getAudioParamConnections(source.context, destination),
    ...
    var deleteInputConnectionOfAudioParam = function deleteInputConnectionOfAudioParam(source, destination, output) {
      var _getAudioParamConnect3 = getAudioParamConnections(source.context, destination),
    ...
    var deleteInputsOfAudioNode = function deleteInputsOfAudioNode(source, destination, output, input) {
      var _deleteInputConnectio = deleteInputConnectionOfAudioNode(source, destination, output, input),
          ...
          internalState = _deleteInputConnectio2[1];
    ...
    var deleteInputsOfAudioParam = function deleteInputsOfAudioParam(source, destination, output) {
      var _deleteInputConnectio3 = deleteInputConnectionOfAudioParam(source, destination, output),
          ...
          internalState = _deleteInputConnectio4[1];
    ...
    var deleteConnectionToDestination = function deleteConnectionToDestination(source, destination, output, input) {
      ...
      }).reduce(function (numberOfDeletedConnections, outputConnection) {
        if (isAudioNodeOutputConnection(outputConnection)) {
          deleteInputsOfAudioNode.apply(void 0, [source].concat(_toConsumableArray(outputConnection)));
        } else {
          deleteInputsOfAudioParam.apply(void 0, [source].concat(_toConsumableArray(outputConnection)));
    ...
    var createAudioNodeConstructor = function createAudioNodeConstructor(createIndexSizeError, createInvalidAccessError, createNotSupportedError, isNativeOfflineAudioContext) {
      return (
        /*#__PURE__*/
        function (_EventTarget) {
          _inherits(AudioNode, _EventTarget);

          function AudioNode(context, internalState, nativeAudioNode, audioNodeRenderer) {
            var _this;
            ...
            if (internalState === 'active') {
              ACTIVE_AUDIO_NODE_STORE.add(_assertThisInitialized(_this));
            }
          ...
          _createClass(AudioNode, [{
            ...
            value: function connect(destination) {
              ...
              var detectCycles = function detectCycles(source, dstntn) {
                var audioNodeOfDestination = isAudioNode(dstntn) ? dstntn : getValueForKey(AUDIO_PARAM_AUDIO_NODE_STORE, dstntn);
                ...
                var _getAudioNodeConnecti9 = getAudioNodeConnections(audioNodeOfDestination),
                ...
                try {
                  for (var _iterator4 = outputs[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    var outputConnection = _step4.value;
              ...
              if (isAudioNode(destination)) {
                ...
                try {
                  ...
                  if (isAudioWorkletNode(destination)) {
                    var auxiliaryGainNodes = AUXILIARY_GAIN_NODE_STORE.get(nativeDestinationAudioNode);
    ...
    var createAudioParamFactory = function createAudioParamFactory(createAudioParamRenderer, nativeAudioContextConstructor) {
    ...
    var createAudioParamRenderer = function createAudioParamRenderer() {
      ...
      return {
        ...
        replay: function replay(audioParam) {
          for (var _i = 0, _automations = automations; _i < _automations.length; _i++) {
            var automation = _automations[_i];
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function AudioWorkletNode(context, name) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(AudioWorkletNode).call(this, context, 'active', nativeAudioWorkletNode, audioWorkletNodeRenderer));
            var parameters = [];
      ...
      return function (name, options, processorDefinition) {
        ...
        function () {
          ...
          _regeneratorRuntime.mark(function _callee4(proxy, nativeOfflineAudioContext) {
            var nativeAudioNode, _numberOfInputChannels, numberOfParameters, partialOfflineAudioContext, gainNodes, inputChannelSplitterNodes, i, constantSourceNodes, inputChannelMergerNode, _i, j, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, index, constantSourceNode, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _step2$value, nm, audioParam, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _step3$value;
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 6:
                    ...
                    partialOfflineAudioContext = new nativeOfflineAudioContextConstructor(_numberOfInputChannels + numberOfParameters, // Ceil the length to the next full render quantum.
                          ...
                          while (1) {
                            switch (_context3.prev = _context3.next) {
                              ...
                              case 7:
                                ...
                                audioBufferSourceNode.connect = connectMultipleOutputs.bind(null, outputAudioNodes);
                                audioBufferSourceNode.disconnect = disconnectMultipleOutputs.bind(null, outputAudioNodes);
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function BiquadFilterNode(context) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(BiquadFilterNode).call(this, context, 'passive', nativeBiquadFilterNode, biquadFilterNodeRenderer)); // Bug #80: Edge & Safari do not export the correct values for maxValue and minValue.

            _this._Q = createAudioParam(_assertThisInitialized(_this), isOffline, nativeBiquadFilterNode.Q, MOST_POSITIVE_SINGLE_FLOAT, MOST_NEGATIVE_SINGLE_FLOAT); // Bug #78: Edge & Safari do not export the correct values for maxValue and minValue.

            _this._detune = createAudioParam(_assertThisInitialized(_this), isOffline, nativeBiquadFilterNode.detune, MOST_POSITIVE_SINGLE_FLOAT, MOST_NEGATIVE_SINGLE_FLOAT); // Bug #77: Chrome, Edge, Firefox, Opera & Safari do not export the correct values for maxValue and minValue.

            _this._frequency = createAudioParam(_assertThisInitialized(_this), isOffline, nativeBiquadFilterNode.frequency, MOST_POSITIVE_SINGLE_FLOAT, MOST_NEGATIVE_SINGLE_FLOAT); // Bug #79: Edge & Safari do not export the correct values for maxValue and minValue.

            _this._gain = createAudioParam(_assertThisInitialized(_this), isOffline, nativeBiquadFilterNode.gain, MOST_POSITIVE_SINGLE_FLOAT, MOST_NEGATIVE_SINGLE_FLOAT);
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function ChannelMergerNode(context) {
            ...
            return _possibleConstructorReturn(this, _getPrototypeOf(ChannelMergerNode).call(this, context, 'passive', nativeChannelMergerNode, channelMergerNodeRenderer));
          }
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function ChannelSplitterNode(context) {
            ...
            return _possibleConstructorReturn(this, _getPrototypeOf(ChannelSplitterNode).call(this, context, 'passive', nativeChannelSplitterNode, channelSplitterNodeRenderer));
          }
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function ConstantSourceNode(context) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(ConstantSourceNode).call(this, context, 'passive', nativeConstantSourceNode, constantSourceNodeRenderer));
          ...
          _createClass(ConstantSourceNode, [{
            ...
            value: function start() {
              ...
              if (this._constantSourceNodeRenderer !== null) {
                ...
                var setInternalStateToInactive = function setInternalStateToInactive() {
                  _this2._nativeConstantSourceNode.removeEventListener('ended', setInternalStateToInactive); // @todo Determine a meaningful delay instead of just using one second.
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function ConvolverNode(context) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(ConvolverNode).call(this, context, 'passive', nativeConvolverNode, convolverNodeRenderer));
            _this._isBufferNullified = false;
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function DelayNode(context) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(DelayNode).call(this, context, 'passive', nativeDelayNode, delayNodeRenderer)); // @todo Edge does not export the correct values for maxValue and minValue.
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function DynamicsCompressorNode(context) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(DynamicsCompressorNode).call(this, context, 'passive', nativeDynamicsCompressorNode, dynamicsCompressorNodeRenderer)); // Bug #110: Edge does not export the correct values for maxValue and minValue.
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function GainNode(context) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(GainNode).call(this, context, 'passive', nativeGainNode, gainNodeRenderer)); // Bug #74: Edge & Safari do not export the correct values for maxValue and minValue.
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function IIRFilterNode(context, options) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(IIRFilterNode).call(this, context, 'passive', nativeIIRFilterNode, iirFilterNodeRenderer)); // Bug #23 & #24: FirefoxDeveloper does not throw an InvalidAccessError.
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function MediaElementAudioSourceNode(context, options) {
            ...
            var mergedOptions = _objectSpread$f({}, DEFAULT_OPTIONS$d, {}, options);

            var nativeMediaElementAudioSourceNode = createNativeMediaElementAudioSourceNode(nativeContext, mergedOptions);
            _this = _possibleConstructorReturn(this, _getPrototypeOf(MediaElementAudioSourceNode).call(this, context, 'active', nativeMediaElementAudioSourceNode, null)); // Bug #63: Edge & Firefox do not expose the mediaElement yet.
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function MediaStreamAudioSourceNode(context, options) {
            ...
            var mergedOptions = _objectSpread$g({}, DEFAULT_OPTIONS$e, {}, options);

            var nativeMediaStreamAudioSourceNode = createNativeMediaStreamAudioSourceNode(nativeContext, mergedOptions);
            _this = _possibleConstructorReturn(this, _getPrototypeOf(MediaStreamAudioSourceNode).call(this, context, 'active', nativeMediaStreamAudioSourceNode, null)); // Bug #63: Edge & Firefox do not expose the mediaStream yet.
    ...
    var createMediaStreamTrackAudioSourceNodeConstructor = function createMediaStreamTrackAudioSourceNodeConstructor(createNativeMediaStreamTrackAudioSourceNode, createNotSupportedError, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
      return (
        /*#__PURE__*/
        function (_noneAudioDestination) {
          _inherits(MediaStreamTrackAudioSourceNode, _noneAudioDestination);
          ...
          function MediaStreamTrackAudioSourceNode(context, options) {
            ...
            var mergedOptions = _objectSpread$h({}, DEFAULT_OPTIONS$f, {}, options);

            var nativeMediaStreamTrackAudioSourceNode = createNativeMediaStreamTrackAudioSourceNode(nativeContext, mergedOptions);
            return _possibleConstructorReturn(this, _getPrototypeOf(MediaStreamTrackAudioSourceNode).call(this, context, 'active', nativeMediaStreamTrackAudioSourceNode, null));
          }
      ...
      return (
        ...
        function (_minimalBaseAudioCont) {
          ...
          function MinimalOfflineAudioContext(options) {
            ...
            var _DEFAULT_OPTIONS$opti = _objectSpread$i({}, DEFAULT_OPTIONS$g, {}, options),
                length = _DEFAULT_OPTIONS$opti.length,
                numberOfChannels = _DEFAULT_OPTIONS$opti.numberOfChannels,
                sampleRate = _DEFAULT_OPTIONS$opti.sampleRate;
        ...
        if (nativeAudioWorkletNodeConstructor !== null) {
          try {
            ...
            var nativeAudioWorkletNode = createNativeAudioNode(nativeContext, function (ntvCntxt) {
              return isNativeOfflineAudioContext(ntvCntxt) && options.numberOfInputs !== 0 && options.numberOfOutputs === 0 ? new nativeAudioWorkletNodeConstructor(ntvCntxt, name, _objectSpread$j({}, options, {
                numberOfOutputs: 1,
                outputChannelCount: [1],
                parameterData: _objectSpread$j({}, options.parameterData, {
                  hasNoOutput: 1
                })
      ...
      return function (nativeContext, baseLatency, processorDefinition, options) {
        ...
        var nativeAudioWorkletNodeFaker = {
          ...
          set channelInterpretation(value) {
            for (var _i4 = 0, _gainNodes = gainNodes; _i4 < _gainNodes.length; _i4++) {
              var gainNode = _gainNodes[_i4];
        ...
        var parameters = processorDefinition.parameterDescriptors === undefined ? [] : processorDefinition.parameterDescriptors.reduce(function (prmtrs, _ref2) {
          var name = _ref2.name;
          return _objectSpread$k({}, prmtrs, _defineProperty({}, name, new Float32Array(128)));
        }, {});
        var isActive = true;
        ...
        scriptProcessorNode.onaudioprocess = function (_ref3) {
          ...
          if (audioWorkletProcessor !== null) {
            var _loop2 = function _loop2(_i5) {
              ...
              try {
                var potentiallyEmptyInputs = inputs.map(function (input, index) {
                  var auxiliaryGainNodes = AUXILIARY_GAIN_NODE_STORE.get(nativeAudioWorkletNodeFaker);
    ...
    var interceptConnections = function interceptConnections(original, interceptor) {
      original.connect = function (destination) // tslint:disable-line:no-inferrable-types
      {
        var output = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
        var input = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
    ...
    var createNativeConstantSourceNodeFakerFactory = function createNativeConstantSourceNodeFakerFactory(createNativeAudioBufferSourceNode, createNativeGainNode) {
      return function (nativeContext, _ref) {
        ...
        var gainNode = createNativeGainNode(nativeContext, _objectSpread$l({}, audioNodeOptions, {
          gain: offset
        })); // Bug #5: Safari does not support copyFromChannel() and copyToChannel().
    ...
    var createNativeConvolverNodeFactory = function createNativeConvolverNodeFactory(createNativeAudioNode, createNotSupportedError) {
      return function (nativeContext, options) {
        ...
        assignNativeAudioNodeOption(nativeConvolverNode, options, 'buffer'); // Bug #113: Edge & Safari allow to change the channelCount
    ...
    var createNativeMediaStreamAudioSourceNodeFactory = function createNativeMediaStreamAudioSourceNodeFactory(createInvalidStateError, createNativeAudioNode) {
      return function (nativeAudioContext, _ref) {
        ...
        var nativeMediaElementAudioSourceNode = createNativeAudioNode(nativeAudioContext, function (ntvDCntxt) {
           ...
           */
          return ntvDCntxt.createMediaStreamSource( // @todo This is using a global object without any previous checks.
          'mediaStream' in MediaStreamAudioSourceNode.prototype ? mediaStream : mediaStream.clone());
    ...
    var createNativePannerNodeFakerFactory = function createNativePannerNodeFakerFactory(createInvalidStateError, createNativeAudioNode, createNativeChannelMergerNode, createNativeGainNode, createNativeScriptProcessorNode, createNativeWaveShaperNode, createNotSupportedError) {
      return function (nativeContext, _ref) {
        ...
        var inputGainNode = createNativeGainNode(nativeContext, _objectSpread$m({}, audioNodeOptions, {
          gain: 1
        }));
        var orientationXGainNode = createNativeGainNode(nativeContext, _objectSpread$m({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 1
        }));
        var orientationYGainNode = createNativeGainNode(nativeContext, _objectSpread$m({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        }));
        var orientationZGainNode = createNativeGainNode(nativeContext, _objectSpread$m({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        }));
        var positionXGainNode = createNativeGainNode(nativeContext, _objectSpread$m({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        }));
        var positionYGainNode = createNativeGainNode(nativeContext, _objectSpread$m({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        }));
        var positionZGainNode = createNativeGainNode(nativeContext, _objectSpread$m({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        }));
        var scriptProcessorNode = createNativeScriptProcessorNode(nativeContext, 256, 6, 0);
        var waveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$m({}, SINGLE_CHANNEL_OPTIONS, {
    ...
    var createNativeStereoPannerNodeFakerFactory = function createNativeStereoPannerNodeFakerFactory(createNativeChannelMergerNode, createNativeChannelSplitterNode, createNativeGainNode, createNativeWaveShaperNode, createNotSupportedError) {
      ...
      var SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS = _objectSpread$n({}, SINGLE_CHANNEL_OPTIONS, {
        oversample: 'none'
      });
      ...
      var buildInternalGraphForMono = function buildInternalGraphForMono(nativeContext, inputGainNode, panGainNode, channelMergerNode) {
        ...
        var leftGainNode = createNativeGainNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var leftWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
          curve: leftWaveShaperCurve
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var panWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
          curve: DC_CURVE
        }));
        var rightGainNode = createNativeGainNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var rightWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
      ...
      var buildInternalGraphForStereo = function buildInternalGraphForStereo(nativeContext, inputGainNode, panGainNode, channelMergerNode) {
        ...
        var leftInputForLeftOutputGainNode = createNativeGainNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var leftInputForLeftOutputWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
          curve: leftInputForLeftOutputWaveShaperCurve
        }));
        var leftInputForRightOutputGainNode = createNativeGainNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var leftInputForRightOutputWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
        ...
        var rightInputForLeftOutputGainNode = createNativeGainNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var rightInputForLeftOutputWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
          curve: rightInputForLeftOutputWaveShaperCurve
        }));
        var rightInputForRightOutputGainNode = createNativeGainNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_OPTIONS, {
          gain: 0
        })); // Bug #119: Safari does not fully support the WaveShaperNode.

        var rightInputForRightOutputWaveShaperNode = createNativeWaveShaperNode(nativeContext, _objectSpread$n({}, SINGLE_CHANNEL_WAVE_SHAPER_OPTIONS, {
      ...
      return function (nativeContext, _ref) {
        ...
        var channelMergerNode = createNativeChannelMergerNode(nativeContext, _objectSpread$n({}, audioNodeOptions, {
          channelCount: 1,
          channelCountMode: channelCountMode,
          numberOfInputs: 2
        }));
        var inputGainNode = createNativeGainNode(nativeContext, _objectSpread$n({}, audioNodeOptions, {
    ...
    var createNativeWaveShaperNodeFakerFactory = function createNativeWaveShaperNodeFakerFactory(createInvalidStateError, createNativeAudioNode, createNativeGainNode) {
      return function (nativeContext, _ref) {
        ...
        var inputGainNode = createNativeGainNode(nativeContext, _objectSpread$o({}, audioNodeOptions, {
          gain: 1
        }));
        var invertGainNode = createNativeGainNode(nativeContext, _objectSpread$o({}, audioNodeOptions, {
          gain: -1
        }));
        var outputGainNode = createNativeGainNode(nativeContext, _objectSpread$o({}, audioNodeOptions, {
          gain: 1
        }));
        var revertGainNode = createNativeGainNode(nativeContext, _objectSpread$o({}, audioNodeOptions, {
          gain: -1
        }));
    ...
    var createNoneAudioDestinationNodeConstructor = function createNoneAudioDestinationNodeConstructor(audioNodeConstructor) {
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function NoneAudioDestinationNode(context, internalState, nativeAudioNode, audioNodeRenderer) {
            _classCallCheck(this, NoneAudioDestinationNode);

            return _possibleConstructorReturn(this, _getPrototypeOf(NoneAudioDestinationNode).call(this, context, internalState, nativeAudioNode, audioNodeRenderer));
          }
      ...
      return (
        ...
        function (_baseAudioContextCons) {
          ...
          function OfflineAudioContext(a, b, c) {
            ...
            var _DEFAULT_OPTIONS$opti = _objectSpread$p({}, DEFAULT_OPTIONS$h, {}, options),
                length = _DEFAULT_OPTIONS$opti.length,
                numberOfChannels = _DEFAULT_OPTIONS$opti.numberOfChannels,
                sampleRate = _DEFAULT_OPTIONS$opti.sampleRate;
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function OscillatorNode(context) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(OscillatorNode).call(this, context, 'passive', nativeOscillatorNode, oscillatorNodeRenderer)); // Bug #81: Edge, Firefox & Safari do not export the correct values for maxValue and minValue.
          ...
          _createClass(OscillatorNode, [{
            ...
            value: function start() {
              ...
              if (this._oscillatorNodeRenderer !== null) {
                ...
                var setInternalStateToInactive = function setInternalStateToInactive() {
                  _this2._nativeOscillatorNode.removeEventListener('ended', setInternalStateToInactive); // @todo Determine a meaningful delay instead of just using one second.
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function PannerNode(context) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(PannerNode).call(this, context, 'passive', nativePannerNode, pannerNodeRenderer));
    ...
    var createPeriodicWaveConstructor = function createPeriodicWaveConstructor(createNativePeriodicWave) {
      return function PeriodicWave(context, options) {
        ...
        var mergedOptions = _objectSpread$s({}, DEFAULT_OPTIONS$k, {}, options); // This does violate all good pratices but it is used here to simplify the handling of periodic waves.
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function StereoPannerNode(context) {
            ...
            var mergedOptions = _objectSpread$t({}, DEFAULT_OPTIONS$l, {}, options);
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(StereoPannerNode).call(this, context, 'passive', nativeStereoPannerNode, stereoPannerNodeRenderer)); // Bug #106: Edge does not export a maxValue and minValue property.
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function WaveShaperNode(context) {
            ...
            var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_OPTIONS$m;

            _classCallCheck(this, WaveShaperNode);

            var nativeContext = getNativeContext(context);

            var mergedOptions = _objectSpread$u({}, DEFAULT_OPTIONS$m, {}, options);
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(WaveShaperNode).call(this, context, 'passive', nativeWaveShaperNode, waveShaperNodeRenderer));
    ...
    var audioNodeConstructor = createAudioNodeConstructor(createIndexSizeError, createInvalidAccessError, createNotSupportedError, isNativeOfflineAudioContext);
    ...
    var createAudioParam = createAudioParamFactory(createAudioParamRenderer, nativeAudioContextConstructor);
    ...
    var mediaStreamTrackAudioSourceNodeConstructor = createMediaStreamTrackAudioSourceNodeConstructor(createNativeMediaStreamTrackAudioSourceNode, createNotSupportedError, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor);
