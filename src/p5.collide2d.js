...
let initP5Collide = p5 => {
    p5.__proto__._collideDebug = false;

    p5.__proto__.collideDebug = function(debugMode) {
        _collideDebug = debugMode;
    };

    /*~++~+~+~++~+~++~++~+~+~ 2D ~+~+~++~+~++~+~+~+~+~+~+~+~+~+~+*/

    p5.__proto__.collideRectRect = function(x, y, w, h, x2, y2, w2, h2) {
        //2d
    ...
    p5.__proto__.collideRectCircle = function(
        rx,
        ry,
        rw,
        rh,
    ...
    p5.__proto__.collideCircleCircle = function(x, y, d, x2, y2, d2) {
        //2d
    ...
    p5.__proto__.collidePointCircle = function(x, y, cx, cy, d) {
        //2d
    ...
    p5.__proto__.collidePointEllipse = function(x, y, cx, cy, dx, dy) {
        //2d
        var rx = dx / 2,
            ry = dy / 2;
    ...
    p5.__proto__.collidePointRect = function(pointX, pointY, x, y, xW, yW) {
        //2d
        if (
    ...
    p5.__proto__.collidePointLine = function(px, py, x1, y1, x2, y2, buffer) {
    ...
    p5.__proto__.collideLineCircle = function(
        x1,
        y1,
        x2,
        y2,
    ...
    p5.__proto__.collideLineLine = function(
        x1,
        y1,
        x2,
        y2,
    ...
    p5.__proto__.collideLineRect = function(
        x1,
        y1,
        x2,
        y2,
    ...
    p5.__proto__.collidePointPoly = function(px, py, vertices) {
        var collision = false;
    ...
    // POLYGON/CIRCLE
    p5.__proto__.collideCirclePoly = function(
        cx,
        cy,
        diameter,
        vertices,
    ...
    p5.__proto__.collideRectPoly = function(
        rx,
        ry,
        rw,
        rh,
    ...
    p5.__proto__.collideLinePoly = function(x1, y1, x2, y2, vertices) {
        // go through each of the vertices, plus the next vertex in the list
        var next = 0;
        for (var current = 0; current < vertices.length; current++) {
            // get next vertex in list if we've hit the end, wrap around to 0
    ...
    p5.__proto__.collidePolyPoly = function(p1, p2, interior) {
        if (interior == undefined) {
            interior = false;
        }
    ...
    p5.__proto__.collidePointTriangle = function(
        px,
        py,
        x1,
        y1,
    ...
    p5.__proto__.collidePointPoint = function(x, y, x2, y2, buffer) {
        if (buffer == undefined) {
            buffer = 0;
        }
    ...
    p5.__proto__.collidePointArc = function(
        px,
        py,
        ax,
        ay,
